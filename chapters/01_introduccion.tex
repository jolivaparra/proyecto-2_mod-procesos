...
El análisis preliminar del sistema (simulaciones en lazo abierto sin refrigeración) revela que, bajo condiciones de alta carga térmica, el panel tiende a alcanzar temperaturas de equilibrio cercanas a los \SI{71}{\degreeCelsius}. Este comportamiento supera ampliamente su estándar de operación, conllevando dos riesgos:
\begin{enumerate}
...
Todos estos objetivos descritos cumplen con lo solicitado en cada punto en la guía del Proyecto 2.