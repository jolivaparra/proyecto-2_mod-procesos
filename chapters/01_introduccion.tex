...
El análisis preliminar del sistema (simulaciones en lazo abierto sin intervención de control) revela que, bajo condiciones de alta carga térmica, el panel tiende a alcanzar temperaturas de equilibrio cercanas a los \SI{71}{\degreeCelsius}. Este comportamiento supera ampliamente su estandar de operación, conllevando dos riesgos:
\begin{enumerate}
...
\begin{itemize}
    ...
    \item Sintonizar la ganancia ($K_c$) y el punto de operación (Offset) para eliminar oscilaciones y asegurar el límite térmico.
