...
\begin{itemize}
    \item $\mathbf{R_\text{vent}}$: Los ventiladores trabajan comúnmente potencias entre \SI{5}{\watt} y \SI{15}{\watt}, para el ventilador se tomó una aproximación de \SI{12}{\watt} de potencia nominal, de esta forma podemos realizar aproximaciones de la resistencia equivalente:
          \begin{equation*}
