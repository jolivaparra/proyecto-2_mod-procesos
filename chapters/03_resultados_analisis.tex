...
Se contrastó el consumo del controlador propuesto ($K_c=-0.25$) frente a una operación en Lazo Abierto con señal fija ($V_{vent}=\qty{12}{\volt}, V_{bomb}=\qty{3}{\volt}$) bajo el escenario de mayor demanda (Día Soleado). En las Figuras \ref{fig:plot:energia-consumida-lazo-abierto} y \ref{fig:plot:energia-consumida-lazo-cerrado} se observa la energía acomulada a lo largo del día mencionado.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{plots/energia-lazo-abierto.pdf}
    \caption{Energía Consumida por el sistema de regriferación en Lazo Abierto.}
...
\begin{figure}[H]
    ...
    \caption{Energía Consumida por el sistema de regriferación en Lazo Cerrado.}
