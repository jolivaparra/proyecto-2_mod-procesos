...
\begin{itemize}
    ...
    \item \textbf{Simulación en Entorno Controlado:} Se llevará a cabo una simulación específica en el entorno controlado descrito en la Sección \ref{ssec:escenarions-de-simulacion}. Esta prueba se centrará en la evaluación de las métricas temporales de desempeño del sistema, permitiendo un análisis sin la presencia de perturbaciones.
