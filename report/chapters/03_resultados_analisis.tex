...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        \caption{Temperatura (\unit{\degreeCelsius}) del panel solar.}
        \label{fig:plot:comparativa-kp-a}
    \end{subfigure}
    \hfil
    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[width=\textwidth]{plots/comparativa-Kp-volt.pdf}
        \caption{Tensión (\unit{\volt}) aplicada en cada actuador.}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        \caption{Temperatura (\unit{\degreeCelsius}) del panel.}
        \label{fig:plot:entorno-controlado-a}
    \end{subfigure}
    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[width=\textwidth]{plots/entorno-controlado-volt.pdf}
        \caption{Tensión (\unit{\volt}) aplicada en los actuadores.}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        \caption{Tensión (\unit{\volt}) aplicada a los actuadores.}
...
Se contrastó el consumo del controlador propuesto ($K_c=-0.25$) frente a una operación en Lazo Abierto con señal fija ($V_{vent}=\qty{12}{\volt}, V_{bomb}=\qty{3}{\volt}$) bajo el escenario de mayor demanda (Día Soleado).

\begin{figure}[H]
    \centering
    % Puedes poner los dos gráficos uno al lado del otro o uno bajo el otro
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{plots/energia-lazo-abierto.pdf}
        \caption{Lazo Abierto (Fijo).}
    \end{subfigure}
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{plots/energia-dia-despejado.pdf}
        \caption{Lazo Cerrado (Modulado).}
    \end{subfigure}
    \caption{Comparativa de acumulación de energía durante un ciclo de 24 horas.}
    \label{fig:res:comparativa_energia_plots}
\end{figure}
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|c|}
        ...
        Lazo Cerrado (Propuesto) & \qty{0.037}{\kilo\watt{}\hour} & \qty{0.068}{\kilo\watt{}\hour} & \qty{94.86}{\percent} \\
        \hline
    \end{tabular}
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|c|}
        ...
        Día Intermitente   & 0.003                                             & 0.004                                        & 0.007                                            \\
        Día Nublado (Mín)  & 0.019                                             & 0.009                                        & 0.027                                            \\
        \hline
    \end{tabular}
...
\begin{itemize}
    \item \textbf{Ahorro Significativo:} La implementación del lazo cerrado genera un ahorro del \textbf{[X]\%} respecto a la operación fija. Esto valida que modular la potencia es económicamente superior a mantener el sistema encendido al máximo, incluso en el día más caluroso.
